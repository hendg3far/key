        ...
        _initTemplateDefaults: function() {
            var self = this,
                ...
                tStats, tModalLabel, renderObject = function(type, mime) {
                    return '<div class="pretty p-default p-smooth p-round"><input type="checkbox" /><div class="state p-warning"><label class="small"> </label></div></div> <object class="kv-preview-data file-preview-' + type + '" title="{caption}" ' +
